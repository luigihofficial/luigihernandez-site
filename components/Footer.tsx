        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1rem' }}>
              ...
              <span style={{ color: '#FAF8F4', fontWeight: 600, fontSize: '1rem' }}>
                Luigi Hernandez
              </span>
            </div>
            <p style={{ color: 'rgba(250,248,244,0.6)', fontSize: '0.875rem', lineHeight: 1.7, maxWidth: '260px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {socials.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = '#C4922A' }}
